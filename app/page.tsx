...
export default async function Home({
  ...
  const filters: PostFilters = {
    ...
    outlierViewsMin: parseNum(params.ovMin),
    outlierViewsMax: parseNum(params.ovMax),
    outlierEngMin: parseNum(params.oeMin),
    outlierEngMax: parseNum(params.oeMax),
    outlierConfidence: params.outlierConfidence,
