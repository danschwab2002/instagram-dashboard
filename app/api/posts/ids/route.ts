...
export async function GET(request: NextRequest) {
  ...
  const filters: PostFilters = {
    ...
    outlierViewsMin: parseNum(sp.get("ovMin")),
    outlierViewsMax: parseNum(sp.get("ovMax")),
    outlierEngMin: parseNum(sp.get("oeMin")),
    outlierEngMax: parseNum(sp.get("oeMax")),
    outlierConfidence: sp.get("outlierConfidence") || undefined,
